...
export const els = {
  ...
  dashboardMenuButton: document.querySelector("[data-dashboard-menu]"),
  dashboardDropdown: document.querySelector("[data-dashboard-dropdown]"),
  dashboardNew: document.querySelector("[data-dashboard-new]"),
  dashboardOpen: document.querySelector("[data-dashboard-open]"),
  dashboardImport: document.querySelector("[data-dashboard-import]"),
  dashboardImportInput: document.querySelector("[data-dashboard-import-input]"),
  dashboardDelete: document.querySelector("[data-dashboard-delete]"),
  dashboardRankingFlyout: document.querySelector("[data-dashboard-ranking-flyout]"),
  dashboardRankingFlyoutList: document.querySelector("[data-dashboard-ranking-flyout-list]"),
